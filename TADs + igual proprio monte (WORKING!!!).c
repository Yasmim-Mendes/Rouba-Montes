...
int igualProprioMonte (Pilha *pilhaJogador, Carta cartaDaVez, Jogador jogadorAtual){
  if (pilhaJogador[jogadorAtual.id].topo->carta.numero == cartaDaVez.numero){
    empilhar(&pilhaJogador[jogadorAtual.id], cartaDaVez);
    printf ("Sua carta da vez é igual a carta do topo do seu monte. Você recebeu uma carta!\n");
    return 0;
  }
  else {
...
int main() {
    // Inicialização do jogador e sua pilha de cartas
    Pilha monteJogador;
    ...
    // Definição da carta da vez
    Carta cartaDaVez;
    cartaDaVez.numero = 7;
    cartaDaVez.naipe = 'P';

    // Empilhando uma carta no monte do jogador
    Carta cartaTopoMonte;
    cartaTopoMonte.numero = 8;
    cartaTopoMonte.naipe = 'P';
    empilhar(&monteJogador, cartaTopoMonte);

    // Chamada da função para verificar a carta da vez com o topo do monte do jogador
    igualProprioMonte(&monteJogador, cartaDaVez, jogadorAtual);
